...
namespace EksiSozlukClone.Infastructure.Persistence.Migrations
{
    /// <inheritdoc />
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    EntryComentId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedById = table.Column<Guid>(type: "uuid", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_entrycommentfavorite_entrycomment_EntryComentId",
                        column: x => x.EntryComentId,
                        principalSchema: "dbo",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_entrycommentfavorite_EntryComentId",
                schema: "dbo",
                table: "entrycommentfavorite",
                column: "EntryComentId");
